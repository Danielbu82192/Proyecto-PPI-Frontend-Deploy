...
const NewCard = ({ key, newTitle, newContent, newImage }) => {
    ...
    return (
        <>
            <div key={key} className="flex flex-col md:w-[30%] w-[40%] aspect-[1/.85] p-2 rounded-lg border border-solid border-gray-300 bg-slate-50 cursor-pointer" onClick={() => setShowContentModal(true)}>
